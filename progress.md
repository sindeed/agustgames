...
- Bana 7 Trädgården byggd från Agusts karta. Spelaren startar på S, L är en låst
  dörr och M är målet/hem. Den elaka gubben patrullerar i ordningen 5
  vänster, 2 ner, 5 vänster, 5 höger, 4 ner, 6 vänster,
...
- Bana 7: patrullen loopar för alltid. Efter 17 steg går trädgårdsmannen 4 ner,
  6 vänster, 6 höger och 9 upp, sedan börjar samma patrull om igen.
- Bana 7: första 3 ner efter första 5 vänster är ändrat till 2 ner.
- Bana 7: trädgårdsmannen ser nu mindre läskig ut med mjukare färger, snällare
  ansikte och mildare varningsmarkering.
- Bana 7: första 2 ner är borttaget; patrullen börjar med 5 vänster och gubben
  tittar vänster direkt från start.
